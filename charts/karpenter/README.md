...
`0.11.0`). No image settings are needed — the chart's `appVersion` pins the
...
```sh
make image IMAGE=<registry>/karpenter-clevercloud TAG=v0.11.0
docker push <registry>/karpenter-clevercloud:v0.11.0
